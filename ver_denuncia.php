...
<body>
    ...
    <div class="contenido-principal">
        ...
        <p><?= htmlspecialchars($noticia['fecha']) ?></p>
        <?php if ($noticia['imagen']): ?>
            <img src="imagenes/denuncias/<?= htmlspecialchars($noticia['imagen']) ?>" class="noticia-imagen" alt="Imagen">
        <?php endif; ?>
        <p><?= nl2br(htmlspecialchars($noticia['descripcion'])) ?></p>
        <div style="text-align: right; margin-top: 10px; margin-right: 10px;">
            <div class="tooltip">
                <a href="reportarDenuncia.php?id=<?= $noticia['id'] ?>">
                <img src="imagenes/reportar.png" alt="Reportar" style="width: 30px; height: 30px; cursor: pointer;">
                </a>
                <div class="tooltip-text">Reportar Denuncia</div>
            </div>
            </div>
        <h3>Comentarios</h3>
